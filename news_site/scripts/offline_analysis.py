...
def autoTagger():
    news_query = New.objects.filter(Q(date__gte="2020-05-18") & Q(date__lte='2020-06-01'))
    sentiment_analysis = Split()
    data = sentiment_analysis.seperate_news(news_query)

def autoSentiment():
    news_query = Tagger.objects.filter(Q(date__gte="2020-05-18") & Q(date__lte='2020-06-01'))
...
def autoAspect():
    news = New.objects.filter(Q(date__gte="2020-05-18") & Q(date__lte='2020-06-01'))
